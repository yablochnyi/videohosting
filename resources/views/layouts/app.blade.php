        ...
        <ul class="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
            <li class="nav-item mx-1">
                @if(\Illuminate\Support\Facades\Auth::check())
                    @if(\Illuminate\Support\Facades\Auth::user()->hasCreatedChannels())
                        <a class="nav-link" href="{{route('upload.video')}}">
                            <i class="fas fa-regular fa-video"></i>
                        </a>
                    @else
                        <a class="nav-link" href="{{route('channel.create')}}">
                            <i class="fas fa-regular fa-video"></i>
                        </a>
                    @endif
                @endif
            ...
            <li class="nav-item dropdown no-arrow osahan-right-navbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    <a class="dropdown-item" href="{{route('channel.create')}}"><i class="fas fa-fw fa-cog"></i> &nbsp;
                        Создать канал</a>
    ...
    <ul class="sidebar navbar-nav">
        <li class="nav-item active">
            <a class="nav-link text-black" href="/">
                ...
                <span class="text-black">Главная</span>
            </a>
        </li>
        <li class="nav-item">
                        ...
                        <li>
                            <a href="{{route('channel.show', $subscribe)}}">
                                <img class="img-fluid" alt=""
                                     src="{{asset('storage/image/' . $subscribe->avatar)}}"> {{$subscribe->name}}
                            </a>
                        </li>
                    @endforeach
                </ul>
